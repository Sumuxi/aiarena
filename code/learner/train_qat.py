...
from vcaponnx.pytorch_tools import qat_qconfig_and_prepare
...
def fuse_model(module_in):
    ...
    # modules_to_fuse = [
    #     ['conv_layers.0', 'conv_layers.1'],
    #     ['hero_share_mlp.0', 'hero_share_mlp.1'],
    #     ['public_info_mlp.0', 'public_info_mlp.1'],
    #     ['soldier_share_mlp.0', 'soldier_share_mlp.1'],
    #     ['organ_share_mlp.0', 'organ_share_mlp.1'],
    #     ['monster_mlp.0', 'monster_mlp.1'],
    #     ['global_mlp.0', 'global_mlp.1'],
    #     ['concat_mlp.0', 'concat_mlp.1'],
    #     ['concat_mlp.2', 'concat_mlp.3'],
    #     ['concat_mlp.4', 'concat_mlp.5'],
    #     ['concat_mlp.6', 'concat_mlp.7'],
    # ]
...
def main(argv):
    ...
    network = fuse_model(network)
    qat_qconfig_and_prepare(network, 'tfqat', scene_mode=0)
