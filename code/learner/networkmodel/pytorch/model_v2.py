...
class NetworkModel(nn.Module):
    def __init__(self):
        ...
        self.hero_frd_mlp = nn.Linear(128, 64)
        self.hero_emy_mlp = nn.Linear(128, 64)
    ...
    def _calculate_single_hero_distill_loss(self, unsqueeze_label_list, student_logits_list, teacher_logits_list,
        ...
        for i in range(len(label_list)):
            ...
            final_loss = (1 - lambda_weight) * hard_label_final_loss + lambda_weight * soft_label_final_loss
