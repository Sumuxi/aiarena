...
class NetworkModel(nn.Module):
    ...
    def forward(self, data_list):
        ...
        for hero_index, hero_data in enumerate(data_list):
            ...
            concat_hidden = torch.cat([hero_frd_hidden_pool, hero_emy_hidden_pool, public_info_hidden, soldier_frd_hidden_pool, soldier_emy_hidden_pool, organ_frd_hidden_pool, organ_emy_hidden_pool, monster_hidden_pool, global_info], dim = 1) # 64+64+32+32+32+32+32+32+68=388
