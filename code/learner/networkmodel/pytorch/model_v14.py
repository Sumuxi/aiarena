...
class NetworkModel(nn.Module):
    ...
    def forward(self, data_list):
        ...
        for hero_index, hero_data in enumerate(data_list):
            ...
            hero_target_list.append(public_info_hidden.reshape((-1, 1, public_info_hidden.shape[-1])))  # 1 public info
            ...
            hero_target_list.append(organ_emy_hidden_pool.reshape((-1, 1, organ_emy_hidden_pool.shape[-1])))  # 1 emy organ
        ...
        for hero_index in range(self.hero_num):
            ...
            target_key = self.target_head(fc_public_result).reshape((-1, 64, 1))  # B*32*1
